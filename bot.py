...
ITEMS = [
        {
        "id": 1,
        "emoji": "<:Touraugrimoire:1404918530012348417>",
        "title": "Tour au Grimoire",
        "description": "Un passage mystique au grimoire, pour effacer ton destin et en écrire un nouveau.",
        "price": 1,
        "emoji_price": "<:ecoEther:1341862366249357374>",
        "quantity": 99999999,
        "tradeable": True,
        "usable": True,
        "use_effect": "Les pages de ton grimoire s’illuminent, se déchirent puis se reforment… un nouveau pouvoir s’y inscrit.",
        "requirements": {},
        "role_id": 1404919388997423185,
