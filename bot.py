...
async def update_embed(self, category):
    ...
    if category == "accueil":
        ...
        embed.add_field(name="👑 Propriétaire :", value=format_mention(self.guild_data.get('owner'), "user"), inline=False)
        embed.add_field(name="🛡️ Rôle Admin :", value=format_mention(self.guild_data.get('admin_role'), "role"), inline=False)
        embed.add_field(name="👥 Rôle Staff :", value=format_mention(self.guild_data.get('staff_role'), "role"), inline=False)
        embed.add_field(name="🚨 Salon Sanctions :", value=format_mention(self.guild_data.get('sanctions_channel'), "channel"), inline=False)
        embed.add_field(name="📝 Salon Alerte :", value=format_mention(self.guild_data.get('reports_channel'), "channel"), inline=False)
